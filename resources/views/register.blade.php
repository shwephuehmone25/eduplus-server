        ...
        <div class="container-wrapper">
            <div class="align-items-center justify-content-center py-4">
                <form
                  ...
                  class="w-80 d-flex col-md-8 flex-column border border-3 forms border-secondary"
                    ...
                    <div class="col-md-6 mb-4">
                      <div class="form-outline">
                        <label
                          ...
                          for="form3Example1n"
                          style="font-size: 1em"
                          >State or Divisions</label
                        >
                        <select name="state" id="">
                          <option value="" disabled selected>Choose State or Division</option>
                            @foreach (\App\Models\User::getStateValues() as $value => $label)
